...
function PrankUI(props: any) {
  ...
  const [debugImage, setDebugImage] = useState(santa)
  ...
  function getPopout() {
    ...
    return (
      <Popout title='Your Popout Title' width={windowWidth} height={windowHeight} closeWindow={() => setShowPopout(false)}>
